...
class protoLoadMarseilleSchoolCSVTest extends TestCase
{
    ...
    public function testinsert_nusery_school_into_db()
    {
    ...
    public function testinsert_elementary_school_into_db()
    {

        $path_csv = "C:\Users\johdu\PhpstormProjects\HackAndHopeDefi3\POC_Tasks\WebView\marseille_ecoles_elementaires_2018.csv"; // initialize the path
