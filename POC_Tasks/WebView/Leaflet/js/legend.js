function createLegend(map) {
    ...
    legend.onAdd = function (map) {
        ...
        div.innerHTML += '<div class="lineLegend"><img class="imgLegend" src="assets/img/cubes-solid.svg">' + '<span class="txtLegend">Ecole maternelle' + '</span></div>'
        div.innerHTML += '<div class="lineLegend"><img class="imgLegend" src="assets/img/linode-brands.svg">' + '<span class="txtLegend">Ecole élémentaire' + '</span></div>'
        div.innerHTML += '<div class="lineLegend"><img class="imgLegend" src="assets/img/child-solid.svg">' + '<span class="txtLegend">Ecole primaire' + '</span></div>'
