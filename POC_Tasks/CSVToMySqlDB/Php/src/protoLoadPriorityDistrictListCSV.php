...
class protoLoadPriorityDistrictListCSV
{
    ...
    function __construct($path_csv='') // constructor
    {
        ...
        $this->load_priority_district_list_csv(); // load csv file with priority district list
    }
    ...
    function load_priority_district_list_csv() { // load priority district list from csv file
